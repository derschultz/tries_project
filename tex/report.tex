...
\newpage
\section{Code}
%TODO make sure the code doesn't go outside the margins! may need to alter code itself. or figure out how to have lstinputlisting do the wrapping for us.
\lstinputlisting[label=header, caption=trie.h]{trie.h}
\newpage
\lstinputlisting[label=code, caption=trie.c]{trie.c}
